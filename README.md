...
- 模擬賣出：可對已持有股票建立最小 SELL 交易
- 交易紀錄：可查看已保存的 BUY / SELL 模擬交易資料
- 持股總覽：依 BUY / SELL 交易彙總目前持股數量、平均成本、持股成本基礎
- 已實現損益：依 SELL 交易與加權平均成本計算每筆已實現損益與累計摘要
- 未實現損益與市值：以最近可取得的收盤價估算持股市值與整體未實現損益摘要
- 投資組合摘要：在持股頁顯示初始資金、可用資金、已使用資金、持股市值、已實現損益、未實現損益與總資產估值
...
- 模擬賣出（股票代號、股票名稱、價格、股數、時間）
- 交易紀錄頁（股票代號、股票名稱、交易類型、價格、股數、時間、總金額、已實現損益）
- 持股總覽頁（股票代號、股票名稱、持股數量、平均成本、持股成本基礎、目前價格、估算市值、未實現損益、投資組合摘要）
